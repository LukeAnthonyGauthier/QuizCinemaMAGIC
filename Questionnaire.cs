...
namespace ProjetPresentationOral
{
    public class Questionnaire
    {
        ...
        public Questionnaire()
        {
            ...
            tableauQuestion[5] = new Question("Lequel des cinq films suivants n'a pas été réalisé par Robert Zemeckis? ", "Le diable s'habille en Prada (Devil Wears Prada)",2, "Retour vers le futur (Back to the Future)", "Boréal Express (The Polar Express)", "Seul au monde (Cast Away)", "La mort vous va si bien (Death Becomes Her)", "Le diable s'habille en Prada (Devil Wears Prada)");
			tableauQuestion[6] = new Question("Quel est le MacGuffin dans Fiction pulpeuse (Pulp Fiction)?", "La valise / mallette", 1);
            tableauQuestion[7] = new Question("Quel nom Alex DeLarge, le protagoniste du film Orange mécanique (A Clockwork Orange), donne-t-il à ses amis dans le long métrage?", "Droogs", 2, "Billyboys",  "Molokos", "Droogs", "Canoneros");
            tableauQuestion[8] = new Question("Quel est le sujet de la dissertation demandée aux cinq jeunes en retenue dans The Breakfast Club?", "Qui pensez-vous être?", 2, "Qui pensez-vous être?","Pourquoi êtes-vous ici aujourd'hui?",  "À quoi aspirez-vous dans la vie?","Qui voudriez-vous devenir?");
            ...
            tableauQuestion[12] = new Question("Parmi ces cinq longs métrages, lequel n'a pas été réalisé par Stanley Kubrick?", "Caligula", 2, "Caligula", "Full Metal Jacket","Dr. Folamour (Dr. Strangelove)","Shining, l'enfant lumière (The Shining)", "2001 : L'Odyssée de l'espace (2001 : Space Odyssey)");
            ...
            tableauQuestion[15] = new Question("Quel est le genre du long métrage Le bon, la brute et le truand (Il buono, il brutto, il cattivo)? ", "Western spaghetti", 2, "Western spaghetti", "Film d'aventure","Western crépusculaire","Film historique","Comédie");
            ...
            tableauQuestion[17] = new Question("De quelle organisation James Bond est-il membre dans la série de films du même nom? ", "MI6", 2,"MIB","FBI", "MI6");
            ...
            tableauQuestion[20] = new Question("Selon l'American Film Institute, à quelle position se retrouve L'exorciste (The Exorcist) de 1973 dans le palmarès des meilleurs thrillers?", "3e", 2, "1er ", "3e","11e");
            ...
            tableauQuestion[26] = new Question("De quelle maladie décède la mère d'Aurore Gagnon dans le film qui porte son prénom?", "Tuberculose", 2, "Pneumonie", "Peste", "Tuberculose", "Choléra","Grippe");
            ...
            tableauQuestion[28] = new Question("Lequel de ces acteurs n’apparaît pas dans Titanic? ", "Mattew McConaughey", 2, "Kathy Bates", "Bill Paxton", "Mattew McConaughey");
            ...
            tableauQuestion[31] = new Question("Qui assure le rôle de Beetlejuice dans le film du même nom?", "Michael Keaton", 2, "Michael Keaton", "Alec Baldwin", "Charles Deetz","Edward Newton");
            ...
            tableauQuestion[35] = new Question("Quel est le nom du motel où l'histoire de Psychose (Psycho) se déroule?", "Adam's Motel", 2,"Bates Motel","Breezwood Motel","Glen Capri Motel", "Adam's Motel");
            tableauQuestion[36] = new Question("Quel est le nom du jeune ami d'E.T. dans le long métrage du même nom?", "Elliott", 2, "Michael", "Elliott", "Henry", "Tyler");
            tableauQuestion[37] = new Question("À quel moment se déroule le Titanic?", "Avril 1912", 2, "Avril 1912", "Septembre 1914","Septembre 1911","Janvier 1911");
            ...
            tableauQuestion[42] = new Question("Quelles sont les trois règles qui s’appliquent lors que l’on prend soin de l’un des Mogwaï du long métrage Les gremlins (Gremlins)?", "Ne pas l’exposer à la lumière, ne pas le mouiller et ne jamais lui donner à manger après minuit.", 2,"Ne pas l’exposer à la lumière, lui donner un bain par jour et ne jamais lui donner à manger après 10 heures.", "Ne pas l’exposer à la lumière, ne pas le mouiller et ne jamais lui donner à manger après minuit.", "Ne pas l’exposer à la lumière du soleil, ne pas le mouiller et ne jamais lui donner à manger après 11 heures.");
            tableauQuestion[43] = new Question("Quel est le nom du meurtrier dans la série de films Halloween?", "Michael Myers", 2, "Freddy Krueger", "Jason Voorhees", "Michael Myers", "Mike Wills");
            ...
            tableauQuestion[46] = new Question("De quel film vient cette citation : « La vie passe très vite. Si vous ne vous arrêtez pas parfois pour l’observer, vous pourriez la rater .» (« Life moves pretty fast. If you don’t stop and look around once in a while, you could miss it. »)?", "La folle journée de Ferris Buller (Ferris Buller’s Day Off)", 2, "Breakfast Club", "La folle journée de Ferris Buller (Ferris Buller’s Day Off)", "Les Goonies (The Goonies)", "Risky Business");
            tableauQuestion[47] = new Question("Quel est le titre de ce film?", "King Kong", 3);
            tableauQuestion[48] = new Question("Lequel de ces cinq films n’a pas été réalisé par Martin Scorsese?", "Gatsby le magnifique (The Great Gatsby)", 2, "Taxi Driver ", "Gatsby le magnifique (The Great Gatsby)", "Shutter Island", "Hugo Cabret","Le loup de Wall Street (The Wolf of Wall Street)");
			tableauQuestion[48] = new Question("", "", 4);
