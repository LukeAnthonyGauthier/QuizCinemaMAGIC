...
namespace ProjetPresentationOral
{
    public class Questionnaire
    {
        ...
        public Questionnaire()
        {
            ...
            tableauQuestion[5] = new Question("Lequel des cinq films suivants n'a pas été réalisé par Robert Zemeckis? ", "Le diable s'habille en Prada (Devil Wears Prada)",2, choix1:"Retour vers le futur (Back to the Future)",choix2: "Boréal Express (The Polar Express)",choix3: "Seul au monde (Cast Away)",choix4: "La mort vous va si bien (Death Becomes Her)");
			tableauQuestion[6] = new Question("Quel est le MacGuffin dans Fiction pulpeuse (Pulp Fiction)?", "La valise / mallette", 1);
            tableauQuestion[7] = new Question("Quel nom Alex DeLarge, le protagoniste du film Orange mécanique (A Clockwork Orange), donne-t-il à ses amis dans le long métrage?", "Droogs", 2, choix1: "Billyboys", choix2: "Molokos",choix3: "Canoneros");
            tableauQuestion[8] = new Question("Quel est le sujet de la dissertation demandée aux cinq jeunes en retenue dans The Breakfast Club?", "Qui pensez-vous être?", 2, choix1: "Pourquoi êtes-vous ici aujourd'hui?", choix2: "À quoi aspirez-vous dans la vie?",choix3: "Qui voudriez-vous devenir?");
            ...
            tableauQuestion[12] = new Question("Parmi ces cinq longs métrages, lequel n'a pas été réalisé par Stanley Kubrick?", "Caligula", 2, choix1: "Full Metal Jacket",choix2: "Dr. Folamour (Dr. Strangelove)",choix3: "Shining, l'enfant lumière (The Shining)",choix4: "2001 : L'Odyssée de l'espace (2001 : Space Odyssey)");
            ...
            tableauQuestion[15] = new Question("Quel est le genre du long métrage Le bon, la brute et le truand (Il buono, il brutto, il cattivo)? ", "Western spaghetti", 2, choix1: "Film d'aventure",choix2: "Western crépusculaire",choix3: "Film historique", choix4: "Comédie");
            ...
            tableauQuestion[17] = new Question("De quelle organisation James Bond est-il membre dans la série de films du même nom? ", "MI6", 2, choix1: "MIB",choix2: "FBI");
            ...
            tableauQuestion[20] = new Question("Selon l'American Film Institute, à quelle position se retrouve L'exorciste (The Exorcist) de 1973 dans le palmarès des meilleurs thrillers?", "3e", 2,choix1: "1er ", choix2: "11e");
            ...
            tableauQuestion[26] = new Question("De quelle maladie décède la mère d'Aurore Gagnon dans le film qui porte son prénom?", "Tuberculose", 2,choix1: "Pneumonie",choix2: "Peste",choix3: "Choléra",choix4: "Grippe");
            ...
            tableauQuestion[28] = new Question("Lequel de ces acteurs n’apparaît pas dans Titanic? ", "Mattew McConaughey", 2,choix1: "Kathy Bates",choix2: "Bill Paxton");
            ...
            tableauQuestion[31] = new Question("Qui assure le rôle de Beetlejuice dans le film du même nom?", "Michael Keaton", 2,choix1: "Alec Baldwin",choix2: "Charles Deetz",choix3: "Edward Newton");
            ...
            tableauQuestion[35] = new Question("Quel est le nom du motel où l'histoire de Psychose (Psycho) se déroule?", "Adam's Motel", 2,choix1: "Bates Motel", choix2: "Breezwood Motel", choix3: "Glen Capri Motel");
            tableauQuestion[36] = new Question("Quel est le nom du jeune ami d'E.T. dans le long métrage du même nom?", "Elliott", 2,choix1: "Michael", choix2: "Henry",choix3: "Tyler");
            tableauQuestion[37] = new Question("À quel moment se déroule le Titanic?", "Avril 1912", 2,choix1: "Septembre 1914",choix2: "Septembre 1911",choix3:"Janvier 1911");
            ...
            tableauQuestion[42] = new Question("Quelles sont les trois règles qui s’appliquent lors que l’on prend soin de l’un des Mogwaï du long métrage Les gremlins (Gremlins)?", "Ne pas l’exposer à la lumière, ne pas le mouiller et ne jamais lui donner à manger après minuit.", 2,choix1: "Ne pas l’exposer à la lumière, lui donner un bain par jour et ne jamais lui donner à manger après 10 heures.",choix2: "Ne pas l’exposer à la lumière du soleil, ne pas le mouiller et ne jamais lui donner à manger après 11 heures.");
            tableauQuestion[43] = new Question("Quel est le nom du meurtrier dans la série de films Halloween?", "Michael Myers", 2,choix1: "Freddy Krueger",choix2: "Jason Voorhees",choix3: "Mike Wills");
            ...
            tableauQuestion[46] = new Question("De quel film vient cette citation : « La vie passe très vite. Si vous ne vous arrêtez pas parfois pour l’observer, vous pourriez la rater .» (« Life moves pretty fast. If you don’t stop and look around once in a while, you could miss it. »)?", "La folle journée de Ferris Buller (Ferris Buller’s Day Off)", 2,choix1: "Breakfast Club",choix2: "Les Goonies (The Goonies)",choix3: "Risky Business");
            tableauQuestion[47] = new Question("Quel est le titre de ce film?", "King Kong", 3);
            tableauQuestion[48] = new Question("Lequel de ces cinq films n’a pas été réalisé par Martin Scorsese?", "Gatsby le magnifique (The Great Gatsby)", 2,choix1: "Taxi Driver ",choix2: "Shutter Island",choix3: "Hugo Cabret",choix4:"Le loup de Wall Street (The Wolf of Wall Street)");
